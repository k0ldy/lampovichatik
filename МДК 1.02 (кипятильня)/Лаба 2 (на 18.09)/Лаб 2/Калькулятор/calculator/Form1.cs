...
namespace calculator
{
    public partial class Form1 : Form
    {
        ...
        private void преобразованиеВеличинToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void преобразованиеВеличинToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            Form2 frm = new Form2();
            frm.Show();
        }
